...
#
# Usage:
#   bash ~/bashscripts/bootstrap/vault/secret-setup.sh          # Full wizard
#   bash ~/bashscripts/bootstrap/vault/secret-setup.sh --unlock  # Unlock vault first
#   bash ~/bashscripts/bootstrap/vault/secret-setup.sh --verify  # Quick check
#   bash ~/bashscripts/bootstrap/vault/secret-setup.sh --diff    # Show what's missing
#
...
_show_help() {
    ...
    echo "  3. bash ~/bashscripts/bootstrap/vault/secret-setup.sh"
