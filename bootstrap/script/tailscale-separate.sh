...
#     wsl -d Ubuntu -- bash ~/bashscripts/bootstrap/script/tailscale-separate.sh wsl
#     wsl -d Ubuntu-22.04 -- bash ~/bashscripts/bootstrap/script/tailscale-separate.sh wsl2
#   Or auto-detect (uses hostname/user):
#     bash ~/bashscripts/bootstrap/script/tailscale-separate.sh --auto
#
